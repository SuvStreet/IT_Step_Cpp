...
int main()
{
	...
	std::map<size_t, size_t> mp { { 1, 1 }, { 2, 4 }, { 3, 9 }, { 4, 16 }, { 5, 25 }, { 6, 36 }, { 7, 49 }, { 8, 64 }, { 9, 81 } };
	// 1) Создали контейнер типа std::map и вставили в него пары { 1, 1 }, { 2, 4 }, { 3, 9 }, { 4, 16 }, { 5, 25 }, { 6, 36 }, { 7, 49 }, { 8, 64 }, { 9, 81 }
	...
	std::cout << "9) Вычислили произведение всех значений словаря по нечетным ключам и вывели его в консоль:\n";
	size_t multi = 1;
	for (auto it = mp.begin(); it != mp.end(); ++it)
